...
namespace data_structs {
	...
	struct formattable {
		...
		__device__ inline formattable(uint64_t nitems){
		...
		//move constructor
		__device__ inline formattable(formattable&& other){
		...
		__device__ inline formattable operator=(const formattable & first){
