#ifndef GALLATIN_FORMATTABLE_RECURSIVE
#define GALLATIN_FORMATTABLE_RECURSIVE
...
namespace data_structs {
	...
	struct formattable_recursive {

		using my_type = formattable_recursive<T, format_code, stride>;
