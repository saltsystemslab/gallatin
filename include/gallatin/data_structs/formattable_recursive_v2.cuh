...
namespace data_structs {
	...
	struct formattable_recursive_alt {
		...
		__device__ inline formattable_recursive_alt(uint64_t nitems): needs_flushed( (((nitems-1)/stride)/64)+1), is_flushed ((((nitems-1)/stride)/64)+1) {
		...
		//move constructor
		__device__ inline formattable_recursive_alt(formattable_recursive_alt&& other){
		...
		__device__ inline formattable_recursive_alt operator=(const formattable_recursive_alt & first){
