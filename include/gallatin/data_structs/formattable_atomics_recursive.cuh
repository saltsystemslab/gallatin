...
namespace data_structs {
	...
	struct formattable_atomic_recursive {
		...
		__device__ formattable_atomic_recursive(uint64_t nitems): needs_flushed((nitems-1)/64+1), is_flushed((nitems-1)/64+1){
		...
		//move constructor
		__device__ formattable_atomic_recursive(formattable_atomic_recursive&& other){
		...
		__device__ formattable_atomic_recursive operator=(const formattable_atomic_recursive & first){
	...
	struct formattable_atomic_recursive<T, format_code, 0> {
		...
		__device__ formattable_atomic_recursive(uint64_t nitems){
